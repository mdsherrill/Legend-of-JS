 ...
 *  Date: 41/2023
 *	Description: Json source class that is used for saving and loading. No
				 unique code was created, but this class creates files of it's
				 own make to list out elements from the class. 
 */ 
